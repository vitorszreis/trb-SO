...
typedef struct fs_info {
	...
	//o superbloco na memoria. Na desmontagem (x=0), quaisquer dados 
	//pendentes de gravacao devem ser persistidos no disco. Retorna um 
	//positivo se a montagem ou desmontagem foi bem sucedida ou, caso 
	//contrario, 0.
	int (*xMountFn) (Disk *d, int x);
